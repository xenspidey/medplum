...
describe('modify default values', () => {
  describe('US Core Patient', () => {
    ...
    function buildPatientContext(defaultValue: any): ElementsContextType {
  ...
  describe('US Core Blood Pressure', () => {
    ...
    function buildObservationContext(defaultValue: any): ElementsContextType {
      return buildElementsContext({
        parentContext: undefined,
        defaultValue,
        elements: schema.elements,
    ...
    test('Minimal input', () => {
      ...
      const observationContext = buildObservationContext(resource);
