...
export function buildElementsContext({
  ...
  if (debugMode) {
    console.debug('Building ElementsContext', { parentPath });
  }
...
// function applyFixed(key: string, element: InternalSchemaElement, value: { [key: string]: any }) {
//   if (!element.fixed) {
//     return;
//   }
//
...
//         const fixed: TypedValue = element.fixed;
//         if (Array.isArray(last)) {
//           last[0][keyPart] = fixed.value;
//         } else {
//           last[keyPart] = fixed.value;
//         }
//       } else {
//         if (!(keyPart in last)) {
...
//   }
// }
// function applyPattern(element: InternalSchemaElement, value: any) {}
